...
Feature: Testing datatables website
  ...
  Scenario: Testing adding new employee to the table
    ...
    And User should enter firstname "Vlad"
    And User should enter lastname "Monchanov"
    ...
    And User enters first name "Vlad" to search box
    Then User should see first name "Vlad" is inserted in the table